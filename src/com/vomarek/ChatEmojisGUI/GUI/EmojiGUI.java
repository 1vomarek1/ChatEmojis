...
public class EmojiGUI {
	...
	public static void open (Player player, Emoji emoji) {
		...
		inv.setItem(11, createGUIItem(ChatColor.GREEN+emoji.getId(), new ArrayList<String>(Arrays.asList(ChatColor.GRAY+emoji.getIdentifier(), ChatColor.GRAY+emoji.getEmoji() ,ChatColor.GRAY+"Permission:",ChatColor.YELLOW+"ChatEmojisGUI.emoji."+emoji.getId())), Material.SIGN, 1));
		...
		inv.setItem(33, createGUIItem(ChatColor.GREEN+"Emoji", new ArrayList<String>(Arrays.asList(ChatColor.GRAY+emoji.getEmoji(), ChatColor.GREEN+"Click "+ChatColor.GRAY+"to change emoji")), Material.PAPER, 1));
